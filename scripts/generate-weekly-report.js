...
- **高亮标记**：对于文本中的关键数据（如 XP、天数、百分比）、表扬关键词（如"说到做到""遵守约定""坚持""小达人"）、关键行为（如"完成作业""阅读30分钟""主动做家务"），用双星号 **包裹它们**，前端会自动高亮显示。每段文字（summary/keep/improve/challenge 及 effortStories 的 story）中至少 2-3 处高亮，让阅读有节奏感。但不要过度标记，只标记真正重要的内容。
- **高亮示例**：如 summary 应写成 "Yara，这周你**遵守了约定**，**坚持每天阅读30分钟**，还**完成了语文作业**，真是**说到做到的小达人**！" 而不是纯平铺文字。keep 应写成 "你**遵守了约定**，真是个**说到做到的小达人**！"
