...
function openEditRuleModal(cat, idx) {
  ...
  document.getElementById('ruleMethod').value = item.method || '按次';
  document.getElementById('ruleIcon').value = guessIcon(item.name) || '⭐';
...
function openAddRuleModal() {
  ...
  document.getElementById('ruleMethod').value = '按次';
...
function saveRule() {
  ...
  var method = document.getElementById('ruleMethod').value;
