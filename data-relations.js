  ...
  var RELATIONS = {
    ...
    xp: {
      ...
      fields: [
        ...
        { key: 'baseXp', name: '基础分值', type: 'number' },
        { key: 'commitmentBonus', name: '承诺奖励', type: 'number' },
        { key: 'date', name: '日期', type: 'date' },
        { key: 'datetime', name: '精确时间', type: 'text' },
        { key: 'domain', name: '板块', type: 'select', options: ['能量', '知识', '财富', '日常'] },
        { key: 'type', name: '类型', type: 'text' },
        { key: 'xpCategory', name: 'XP分类', type: 'text' },
        { key: 'status', name: '状态', type: 'select', options: ['有效', '已撤销'] },
        { key: 'reviewStatus', name: '审核状态', type: 'select', options: ['待确认', '已通过', '已退回'] },
        { key: 'returnReason', name: '退回原因', type: 'textarea' },
    ...
    homework: {
      ...
      fields: [
        { key: 'subject', name: '科目', type: 'select', options: ['语文', '数学', '英语', '科学'] },
        { key: 'title', name: '标题', type: 'text' },
        { key: 'description', name: '描述', type: 'textarea', use: ['description', 'details'] },
        { key: 'homeworkType', name: '作业类型', type: 'select', options: ['假期作业', '特色作业'] },
        { key: 'status', name: '状态', type: 'select', options: [{ v: 'pending', l: '待完成' }, { v: 'done', l: '已完成' }] },
        { key: 'dueDate', name: '截止日期', type: 'date' },
        { key: 'deadline', name: '截止时间', type: 'text' },
        { key: 'module', name: '能力模块', type: 'text' },
        { key: 'modules', name: '模块列表', type: 'textarea' },
        { key: 'tags', name: '标签', type: 'text' },
        { key: 'duration', name: '预计用时', type: 'text' },
        { key: 'unitIndex', name: '单元序号', type: 'text' },
        { key: 'unitName', name: '单元名称', type: 'text' },
        { key: 'wrongCount', name: '错题数', type: 'number' },
        { key: 'errorModules', name: '失分模块', type: 'textarea', use: ['errorModules', 'errorModule'] },
        { key: 'submitted', name: '已提交', type: 'select', options: [{ v: true, l: '是' }, { v: false, l: '否' }] },
        { key: 'submittedAt', name: '提交时间', type: 'text' },
        { key: 'progress', name: '进度', type: 'text' },
        { key: 'reviewStatus', name: '审核状态', type: 'select', options: ['待确认', '已通过', '已退回'] },
        { key: 'returnReason', name: '退回原因', type: 'textarea' },
      ],
    ...
    exam: {
      ...
      fields: [
        ...
        { key: 'subject', name: '科目', type: 'select', options: ['语文', '数学', '英语', '科学'] },
        { key: 'grade', name: '等级', type: 'select', options: ['A+', 'A', 'B+', 'B', 'C+', 'C', 'D'] },
        { key: 'examType', name: '考试类型', type: 'select', options: ['单元测试', '期中考试', '期末考试', '月考', '模拟考'] },
        { key: 'date', name: '日期', type: 'date' },
        { key: 'year', name: '年份', type: 'text' },
        { key: 'description', name: '说明', type: 'textarea' },
        { key: 'errorModules', name: '失分模块', type: 'textarea', use: ['errorModules', 'errorModule'] },
      ],
      cascade: []
    ...
    diary: {
      ...
      fields: [
        ...
        { key: 'mood', name: '心情', type: 'select', options: ['开心', '平静', '兴奋', '难过', '生气', '疲惫'] },
        { key: 'content', name: '内容', type: 'textarea' },
        { key: 'completeFour', name: '四要素', type: 'textarea' },
        { key: 'completeFeel', name: '感受', type: 'textarea' },
        { key: 'xp', name: '分值(XP)', type: 'number' },
        { key: 'hits', name: '阅读数', type: 'number' },
      ],
      cascade: []
    },
    ...
    commitment: {
      ...
      fields: [
        ...
        { key: 'category', name: '分类', type: 'text' },
        { key: 'taskName', name: '关联任务', type: 'text' },
        { key: 'xp', name: '分值(XP)', type: 'number' },
        { key: 'completed', name: '完成', type: 'select', options: [{ v: true, l: '已完成' }, { v: false, l: '未完成' }] },
        { key: 'linked', name: '关联XP记录', type: 'text' },
      ],
      cascade: []
    },
    // AI周报：纯数组文件，展示每周汇总
    aiweekly: {
      ...
      fields: [
        ...
        { key: 'stats', name: '数据统计', type: 'textarea' },
        { key: 'academic', name: '学业分析', type: 'textarea' },
        { key: 'behavior', name: '行为表现', type: 'textarea' },
        { key: 'emotion', name: '情绪状态', type: 'textarea' },
        { key: 'growth', name: '成长亮点', type: 'textarea' },
        { key: 'suggestions', name: '建议', type: 'textarea' },
        { key: 'generatedAt', name: '生成时间', type: 'text' },
      ],
      cascade: []
    },
  };
